...
# This will show if sales data is normally distributed
...
# Very low p-value at 2.2e-16 which indicates great model fit
...
summary(G.NA.lm)
# Reasonable R-Squared of 0.8395
...
# No clear line fit in residuals which means good predictive power of the model
...
# We should also test for multiple regression given just 3 variables.
...
# Or put another way, every extra $1 of Sales in EU, should see Global Sales grow by $1.2
# Standard errors are low so predictive fit should be good.
# Based on the standard errors, we can say on a normal distribution basis
...
par(mfrow=c(2,2))
plot(mlr_model.lm)
# Mean of Residuals (red lines) from MLR are mostly horizontal & centered around 0
